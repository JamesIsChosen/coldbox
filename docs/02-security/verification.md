...
The fingerprint is published in the README and in the app's provenance panel. **Compare it against a source you trust independently** — ideally one you saw before today. A key fetched from the same place as the file it signs proves less than it appears to.
