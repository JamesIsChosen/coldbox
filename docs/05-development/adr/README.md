...
| [0013](0013-save-integrity-in-warm-shell.md) | Save-integrity bookkeeping lives in the warm shell, not the vault format | Accepted · amended by 0025 |
...
| [0025](0025-vault-identity-library-and-save-ux.md) | Vault identity is portable and random; names/library/save UX stay in the warm shell | Accepted |
