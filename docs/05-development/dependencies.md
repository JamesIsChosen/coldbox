...
| SLIP-39 implementation | 0.1.9-adapted | Shamir mnemonic shares | `2009d910cda84e81e3d75f78f6961a9b82258c66513f4160efc25c6a4f6a6c5e` (SHA-256 of the exact LF byte sequence at upstream `src/slip39_helper.js`; Git blob SHA-1 `8bcb9568c6c6191e686de2d34864088c644fc7b2`; v0.1.9 tag commit `414a73b0a28f2fc966514b8f318eb6f68bf9979a`) |
| codex32 implementation | Inline BIP-93 adaptation | BIP-93 hand-verifiable checksum, direct master-seed encoding, and GF(32) shares | `N/A — standard-defined source` |
| Seed XOR implementation | Inline | Coldcard-compatible BIP-39 entropy XOR; no runtime dependency | `N/A` |
