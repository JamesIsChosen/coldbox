...
`lastVerifiedAt` only after all parts reconstruct successfully. The parts,
combined phrase, and any passphrase remain cold-local; the warm shell receives
only the closed success or failure result.
