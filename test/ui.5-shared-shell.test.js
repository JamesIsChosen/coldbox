...
const coldMoreInventory = ['Vault session', 'Entropy Lab', 'Seed Forge', 'Validate phrase', 'Passphrase Studio · First slice', 'Secret notes', 'Reveal hidden', 'Derivation paths · P1.4a · Phase 1', 'Address derivation · P1.4a · Phase 1', 'Child seeds · BIP-85 · P4.6 · Phase 4', 'Descriptors · P4.9 · Phase 4', 'Split lab', 'Verify / combine', 'SeedQR studio', 'Backup Health', 'Recovery Assistant · First slice', 'Verify Bench', 'Level 3 signing · WAL.8 · Phase WAL', 'Animated QR · P4.8 · Phase 4', 'Vault session', 'Active secret', 'Lock &amp; wipe'];
...
test('unbuilt navigation entries are disabled controls with roadmap and phase labels', () => {
  ...
  assert.match(coldHtml, /href="#cold-seed-forge-generated-passphrase" data-cold-more-target="cold-seed-forge-generated-passphrase">Passphrase Studio · First slice/);
...
test('mobile More sheets match the approved route inventories', () => {
  ...
  // Derivation, child-seed, descriptor, signing, and animated QR destinations
  // remain roadmap-owned; the admitted first-slice passphrase and recovery
  // destinations stay live links.
  for (const id of ['P4.6', 'P4.9', 'WAL.8', 'P4.8']) {
