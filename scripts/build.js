...
const coldRealmManifest = Object.freeze([
  ...
  Object.freeze({ file: 'index.html', token: '__COLDBOX_SEED_XOR_LAYER__', content: 'seed-xor.js' }),
  ...
  Object.freeze({ file: 'index.html', token: '__COLDBOX_COLD_FONT_FACES__', content: 'font-faces.css' }),
...
function assembleColdRealm(protocolSource, airgapSource, capabilitiesSource) {
  ...
  const components = new Map([
    ...
    ['seed-xor.js', readSource('cold/seed-xor.js')],
    ...
    ['font-faces.css', createFontFaceSource(projectRoot)],
